    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or
                <a href="/sign-in" class="font-medium text-orange-600 hover:text-orange-500">
                    sign in to existing account
                </a>
            </p>
        </div>

        <form class="mt-8 space-y-6" action="/sign-up" method="POST">
            <?= View::csrf() ?>

            <?php if (isset($inviteId) && $inviteId): ?>
            <input type="hidden" name="inviteId" value="<?= View::e($inviteId) ?>">
